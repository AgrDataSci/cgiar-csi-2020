...
---
class: middle
<img src="img/from-tree-to-map.png" width="100%" style="float:left"/>
...
[<img src="img/chirps.png" width="10%" style="float:left"/>](https://agrobioinfoservices.github.io/chirps/)
...
```{r beans, eval=FALSE, message=FALSE, echo=TRUE}
"script/commonbeans.R"
```
